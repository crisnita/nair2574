...
public class IntegrareInventoryRepo {
    ...
    void deletePart() {
        ...
        parti=inventory.getAllParts();
        assertEquals(parti.isEmpty(),true);
    }
    @Test
    void updateInhousePart(){
        ...
        Mockito.verify(inventory, times(1)).updatePart(indexPart,testPart);
    }
}
