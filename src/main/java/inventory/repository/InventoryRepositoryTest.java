...
class InventoryRepositoryTest {
    ...
    void setup(){
        ...
        service= Mockito.mock(Inventory.class);
    ...
    void addPart() {
        ...
        repo.addPart(parte);
        Mockito.verify(service, Mockito.times(1)).addPart(parte);
    }

    @Test
    void lookupPart() {
        repo.lookupPart(name);
        Mockito.verify(service, Mockito.times(1)).lookupPart(name);
    }
    ...
    void updatePart() {
        ...
        Mockito.verify(service, Mockito.times(1)).updatePart(indexPart,parte);
    }
}