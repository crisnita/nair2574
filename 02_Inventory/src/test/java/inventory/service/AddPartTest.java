...
class AddPartTest {
    ...
    void TC1_ECP() {
        ...
        assertEquals(inhousePart.getPrice(),parte.getPrice());
    }
    @Test
    @Tag("ecp")
    ...
    void TC2_ECP() {
        ...
        InhousePart inhousePart = new InhousePart(inventoryRepository.getAutoPartId(),denumire,pret,numar_bucati,numar_minim,numar_maxim,id_masina);
        inventoryService.addInhousePart(denumire,pret,numar_bucati,numar_minim,numar_maxim,id_masina);
        assertThrows(java.lang.IndexOutOfBoundsException.class,()->{Part parte= inventoryRepository.getAllParts().get(0);});
    ...
    void TC3_ECP() {
        denumire="parte";
        String pret2="asd";
        assertThrows(java.lang.NumberFormatException.class,()->{inventoryService.addInhousePart(denumire,Integer.parseInt(pret2),numar_bucati,numar_minim,numar_maxim,id_masina);});
    }
    @Test()
    @Tag("ecp")
    ...
    void TC4_ECP() {
        int denumire2=123;
        pret=300;
        assertThrows(java.lang.NumberFormatException.class,()->{inventoryService.addInhousePart(String.valueOf(denumire2),pret,numar_bucati,numar_minim,numar_maxim,id_masina);});
    }
    ...
    void TC5_BVA() {
        denumire="";
        pret=100;
        assertThrows(java.lang.Exception.class,()->{inventoryService.addInhousePart(denumire,pret,numar_bucati,numar_minim,numar_maxim,id_masina);});
